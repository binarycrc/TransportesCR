    ...
    public class MainMenu
    {
            ...
            try
            {
                ...
                switch (opcmenu)
                {
                    ...
                    case 5:
                        Console.BackgroundColor = ConsoleColor.Black;
                        Console.ForegroundColor = ConsoleColor.White;
                        Console.Write(" ++ Todos los registros ++ ");
                        Console.BackgroundColor = ConsoleColor.Black;
                        Console.ForegroundColor = ConsoleColor.White;
                        break;
                }
        ...
        public void menuCamion(int opcmenu)
        {
            try
            {
                ...
                if (opcmenu == 0)
                {
                    ...
                    Console.WriteLine();
                    Console.Write("Seleccione una opcion del menu: ");
                    opciondemenu = Console.ReadLine();
                    resultadovalidanumero = Int32.TryParse(opciondemenu, out validanumero);
                    if (resultadovalidanumero)
                    {
                        switch (validanumero)
                        {
        ...
        public void registroCamion()
        {
            try
            {
                ...
                do
                {
                    ...
                    opcguardarLower = opcguardar?.ToLower();
                    if ((opcguardarLower == "s") || (opcguardarLower == "n")) { break; }
                } while (true);

                if (opcguardarLower == "s")
                {
                ...
                if (cuentacamion < camions.Length)
                {
                    do
                    {
                        ...
                        opcotroLower = opcotro?.ToLower();
                        if ((opcotroLower.ToString().ToLower() == "s") || (opcotroLower.ToString().ToLower() == "n")) { break; }
                    } while (true);
                    if (opcotroLower == "s")
                    {
                        menuCamion(1);
        ...
        public void menuBuseta(int opcmenu)
        {
            try
            {
                ...
                if (opcmenu == 0)
                {
                    ...
                    Console.BackgroundColor = ConsoleColor.Green;
                    Console.ForegroundColor = ConsoleColor.Black;
                    if (cuentabuseta < busetas.Length) { Console.Write(" 1.Registro de Busetas "); }
                    Console.Write(" 2.Todos los registros ");
                    Console.BackgroundColor = ConsoleColor.Black;
                    Console.ForegroundColor = ConsoleColor.White;
        ...
        public void registroBuseta()
        {
            try
            {
                ...
                do
                {
                    ...
                    opcguardar = Console.ReadLine();
                    opcguardarLower = opcguardar?.ToLower();
                    if ((opcguardarLower.ToString().ToLower() == "s") || (opcguardarLower.ToString().ToLower() == "n")) { break; }
                } while (true);
        ...
        public void menuConductor(int opcmenu)
        {
            try
            {
                ...
                if (opcmenu == 0)
                {
                    ...
                    Console.BackgroundColor = ConsoleColor.Blue;
                    Console.ForegroundColor = ConsoleColor.Black;
                    if (cuentaconductor < conductors.Length) { Console.Write(" 1.Registro de Conductor "); }
                    Console.Write(" 2.Todos los registros ");
                    Console.BackgroundColor = ConsoleColor.Black;
                    Console.ForegroundColor = ConsoleColor.White;
        ...
        public void registroConductor()
        {
            try
            {
                ...
                do
                {
                    Console.SetCursorPosition(15, 2); capturaentrada = Console.ReadLine();
                    if (Regex.IsMatch(capturaentrada, "^[a-zA-Z0-9]*$")) { identificacion = capturaentrada; break; }
                } while (true);
                do
                {
                    Console.SetCursorPosition(16, 3); capturaentrada = Console.ReadLine();
                    if (Regex.IsMatch(capturaentrada, "^[a-zA-Z0-9]*$")) { papellido = capturaentrada; break; }
                } while (true);
                do
                {
                    Console.SetCursorPosition(17, 4); capturaentrada = Console.ReadLine();
                    if (Regex.IsMatch(capturaentrada, "^[a-zA-Z0-9]*$")) { sapellido = capturaentrada; break; }
                } while (true);

                do
                {
                    Console.SetCursorPosition(6, 5); capturaentrada = Console.ReadLine();
